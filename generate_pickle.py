...
spath="/Users/rb/Documents/project_m"
list1=os.listdir(spath)
del list1[0]
...
for a in list1:
    y,sr=librosa.core.load(spath+a)
...
#plt.colorbar(format='%+2.0f dB')
    plt.axis("off")
    plt.savefig(fname="/Users/rb/Documents/project_m/pics/image5.png",bbox_inches="tight",pad_inches=0)

#Slicing spectrograms into samples of 128 by 128 pixels
    img=Image.open("/Users/rb/Documents/project_m/pics/image5.png")
